										...
										<div class="mb-3 row">
											...
											<div class="col-sm-10">
												<select name="tirange" id="tirange" class="form-control" required/>
													...
													<option >Kalubovitiyana</option>
													<option >Akuressa</option>
													<option >Thibbotuwana</option>
													<option >Kananke</option>
													<option >Ketanwila</option>
													<option >Kamburupitiya</option>
													<option >Thilijjawila</option>
													<option >Pasgoda</option>
													<option >Dampahala</option>
													<option >Urubokka</option>
													<option >Kirillipona</option>
													<option >Deyyandara</option>
													<option >Beralapanathara</option>
													<option >Warapitiya</option>
												</select>
											</div>
										</div>
										<div class="mb-3 row">
