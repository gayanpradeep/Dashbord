...
$data =mysqli_query($conn,"SELECT * FROM tidetails_db");
// $data_table =mysqli_query($conn,"SELECT * FROM tidetails_db ORDER by month ");

$query ="SELECT SUM(titarget) As sum FROM titarget_db";
...
$query2 ="SELECT SUM(starrtarget) As sum2 FROM titarget_db";
...
$query3 ="SELECT SUM(starrachivetarget) As sum3 FROM titarget_db ";
...
$que = "SELECT * FROM titarget_db ";
$result = mysqli_query($conn, $que);
$chart_data = '';
while($row = mysqli_fetch_array($result))
{
	$chart_data .= "{ distric:'".$row["distric"]."', titarget:".$row["titarget"].", achivetarget:".$row["achivetarget"].", starrtarget:".$row["starrtarget"].", starrachivetarget:".$row["starrachivetarget"]."}, ";
}
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="../admin/admin.php">
			...
			<main class="content">
				<div class="container-fluid p-0">
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center; font-family: 'Roboto', sans-serif;">View Srilanka Tea Area</h5>
								</div>
								<!-- <div class="card-body px-4">
									<div id="world_map" style="height:350px;"></div>
								</div> -->
								<div id="map"></div>
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3804856.6219507875!2d78.46150524300963!3d7.851730507542296!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2593cf65a1e9d%3A0xe13da4b400e2d38c!2sSri%20Lanka!5e1!3m2!1sen!2slk!4v1619066467095!5m2!1sen!2slk" width="577" height="499" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div>
						</div>
					...
					<div class="col-md-12">
							<div class="card">
									<div class="card-header">
										<h5 class="card-title" style="color:#000; text-align:center;font-size:30px">All TI Ranges</h5>
									</div>
									<?php
										$mysqli = new mysqli('localhost', 'root', '', 'newdash') or die (mysqli_error($mysqli));
										$result = $mysqli->query("SELECT * FROM titarget_db  ORDER BY distric") or die($mysqli->error);
										//pre_r($result);
									?> 
