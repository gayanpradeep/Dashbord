...
$data =mysqli_query($conn,"SELECT * FROM tidetails_db WHERE distric='Galle'");

$query ="SELECT SUM(titarget) As sum FROM titarget_db WHERE distric='Galle'";
...
$query2 ="SELECT SUM(starrtarget) As sum2 FROM titarget_db WHERE distric='Galle'";
...
$query3 ="SELECT SUM(starrachivetarget) As sum3 FROM titarget_db WHERE distric='Galle'";
...
$que = "SELECT * FROM titarget_db WHERE distric='Galle'";
			...
			<main class="content">
				<div class="container-fluid p-0">
						...
						<div class="col-auto ml-auto text-right mt-n1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
									<li class="breadcrumb-item"><a href="Galle.php">Galle</a></li>
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center; font-family: 'Roboto', sans-serif;">View Galle</h5>
								</div>
								<!-- <div class="card-body px-4">
									<div id="world_map" style="height:350px;"></div>
								</div> -->
								<div id="map"></div>
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63480.84752261896!2d80.17697733056963!3d6.05589042723509!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae173bb6932fce3%3A0x4a35b903f9c64c03!2sGalle!5e0!3m2!1sen!2slk!4v1617791817944!5m2!1sen!2slk" width="577" height="499" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div>
						</div>
					...
					<div class="col-md-12">
							<div class="card">
									<div class="card-header">
										<h5 class="card-title" style="color:#000; text-align:center;font-size:30px">Galle Achivement</h5>
									</div>
									<?php
										$mysqli = new mysqli('localhost', 'root', '', 'newdash') or die (mysqli_error($mysqli));
										$result = $mysqli->query("SELECT * FROM titarget_db WHERE distric='Galle' ORDER BY month") or die($mysqli->error);
										//pre_r($result);
									?> 
