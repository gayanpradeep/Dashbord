...
$query2 ="SELECT SUM(starrtarget) As sum2 FROM titarget_db WHERE distric='Kandy'";
...
$query3 ="SELECT SUM(starrachivetarget) As sum3 FROM titarget_db WHERE distric='Kandy'";
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="kandy.php">
          <span class="align-middle">Kandy</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="kandy.php">
			...
			<main class="content">
				<div class="container-fluid p-0">
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center; font-family: 'Roboto', sans-serif;">View Kandy</h5>
								</div>
								<!-- <div class="card-body px-4">
									<div id="world_map" style="height:350px;"></div>
								</div> -->
								<div id="map"></div>
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63320.430034711004!2d80.59076179784796!3d7.294543952144014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae366266498acd3%3A0x411a3818a1e03c35!2sKandy!5e0!3m2!1sen!2slk!4v1617613647175!5m2!1sen!2slk" width="577" height="499" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div>
						</div>
					...
					<div class="col-md-12">
							<div class="card">
									<div class="card-header">
										<h5 class="card-title" style="color:#000; text-align:center;font-size:30px">Kandy Achivement</h5>
									</div>
									<?php
										$mysqli = new mysqli('localhost', 'root', '', 'newdash') or die (mysqli_error($mysqli));
										$result = $mysqli->query("SELECT * FROM titarget_db WHERE distric='kandy' ORDER BY month") or die($mysqli->error);
										//pre_r($result);
									?> 
