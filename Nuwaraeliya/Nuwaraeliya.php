...
$data =mysqli_query($conn,"SELECT * FROM tidetails_db WHERE distric='Nuwaraeliya'");

$query ="SELECT SUM(titarget) As sum FROM titarget_db WHERE distric='Nuwaraeliya'";
...
$query2 ="SELECT SUM(starrtarget) As sum2 FROM titarget_db WHERE distric='Nuwaraeliya'";
...
$query3 ="SELECT SUM(starrachivetarget) As sum3 FROM titarget_db WHERE distric='Nuwaraeliya'";
...
$que = "SELECT * FROM titarget_db WHERE distric='Nuwaraeliya'";
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="Nuwaraeliya.php">
          <span class="align-middle">Nuwara Eliya</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="Nuwaraeliya.php">
			...
			<main class="content">
				<div class="container-fluid p-0">
						...
						<div class="col-auto ml-auto text-right mt-n1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
									<li class="breadcrumb-item"><a href="Nuwaraeliya.php">Nuwara Eliya</a></li>
						...
						<div class="col-xl-6 col-xxl-7">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center; font-family: 'Roboto', sans-serif;">Recent Movement</h5>
								</div>
						...
						<div class="col-12 col-md-6 col-xxl-3 d-flex order-2 order-xxl-3">
							<div class="card flex-fill w-100" style="flex: 1 0 auto">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center;">TI Details</h5>
									<br>
									<div class="card">
										<?php
						...
						<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0" style="color:#000; text-align:center; font-family: 'Roboto', sans-serif;">View Nuwara Eliya</h5>
								</div>
								<!-- <div class="card-body px-4">
									<div id="world_map" style="height:350px;"></div>
								</div> -->
								<div id="map"></div>
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63367.84209681118!2d80.74592728201047!3d6.951364914269235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae380434e1554c7%3A0x291608404c937d9c!2sNuwara%20Eliya!5e0!3m2!1sen!2slk!4v1617789550667!5m2!1sen!2slk" width="577" height="499" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div>
						</div>
					...
					<div class="col-md-12">
							<div class="card">
									<div class="card-header">
										<h5 class="card-title" style="color:#000; text-align:center;font-size:30px">Nuwara Eliya Achivement</h5>
									</div>
									<?php
										$mysqli = new mysqli('localhost', 'root', '', 'newdash') or die (mysqli_error($mysqli));
										$result = $mysqli->query("SELECT * FROM titarget_db WHERE distric='Nuwaraeliya' ORDER BY month") or die($mysqli->error);
										//pre_r($result);
									?> 
