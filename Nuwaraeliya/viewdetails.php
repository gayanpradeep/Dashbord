...
$query1 = "SELECT * FROM titarget_db WHERE tirange='$tirange' AND distric='Nuwaraeliya'";
...
$query = "SELECT * FROM titarget_db WHERE tirange='$tirange' AND distric='Nuwaraeliya'";
								...
								<div class="card-body">
                                    <!-- <table>
                                        <?php
                                            ...
                                            $query = "SELECT * FROM tidetails_db WHERE tirange='$tirange' AND distric='Nuwaraeliya'";
                                            $result = mysqli_query($conn,$query);
											while($row = mysqli_fetch_array($result))
											{  
												echo '  
									...
									<table>
										<!-- <tr>
										   ...
										   <?php
										   $select =mysqli_query($conn,"SELECT * FROM tidetails_db WHERE tirange='$tirange' AND distric='Nuwaraeliya'");
