...
$data =mysqli_query($conn,"SELECT * FROM tidetails_db WHERE distric='Rathnapura'");

$query ="SELECT SUM(titarget) As sum FROM titarget_db WHERE distric='Rathnapura'";
...
$query1 ="SELECT SUM(achivetarget) As sum1 FROM titarget_db WHERE distric='Rathnapura'";
...
$query2 ="SELECT SUM(starrtarget) As sum2 FROM titarget_db WHERE distric='Rathnapura'";
...
$query3 ="SELECT SUM(starrachivetarget) As sum3 FROM titarget_db WHERE distric='Rathnapura'";
...
$que = "SELECT * FROM titarget_db WHERE distric='Rathnapura'";
			...
			<main class="content">
				<div class="container-fluid p-0">
						...
						<div class="col-auto ml-auto text-right mt-n1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
									<li class="breadcrumb-item"><a href="Rathnapura.php">Rathnapura</a></li>
					...
					<div class="col-md-12">
							<div class="card">
									<div class="card-header">
										<h5 class="card-title" style="color:#000; text-align:center;font-size:30px">Rathnapura Achivement</h5>
									</div>
									<?php
										$mysqli = new mysqli('localhost', 'root', '', 'newdash') or die (mysqli_error($mysqli));
										$result = $mysqli->query("SELECT * FROM titarget_db WHERE distric='Rathnapura' ORDER BY month") or die($mysqli->error);
										//pre_r($result);
									?> 
